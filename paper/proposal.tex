...
the correct page was identified $977$ times out of $1000$ (97.7\%). As on System
...
the victim samples from System 1, the identification was successful 82.4\% of
...
identified the input from 69.6\% of probe sequences recorded on System
2.\footnote{poppler/0007} Using the training set from System 2, we correctly
identified the input from 69.1\% of the probe sequences recorded on System 1.
