...
machine\endnote{It is conceivable that the attacker could perform the training
...
sequences\endnote{We made this change after the System 1 experiments, so this
...
time\endnote{Run links/0005}. With $T=5$ and $S=1$, the correct URL was
recovered 76\% of the time\endnote{Run links/0002}. So the attack is more
accurate when the attacker has more training samples.

We ran a longer experiment\endnote{Run links/0010} on System 2 with $T=5$ and
